...
This package can be found on [packagist](https://packagist.org/packages/natlibfi/php-html-parser) and is best loaded using [composer](http://getcomposer.org/). We support PHP 8.2 - 8.5.
